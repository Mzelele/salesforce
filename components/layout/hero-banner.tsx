...
export async function HeroBanner() {
  ...
  return (
    <section className="aspect-[16/9] sm:h-[280px] sm:aspect-auto lg:h-[392px]">
      <div
        className="relative flex h-full flex-col items-center justify-center overflow-hidden rounded-xl px-5 py-8 text-center sm:rounded-2xl sm:px-8 sm:py-14 md:px-10 md:py-18"
