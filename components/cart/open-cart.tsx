...
export default function OpenCart({
  ...
  return (
    <div className="relative flex h-9 w-9 items-center justify-center rounded-md border border-neutral-200 text-neutral-900 transition-colors md:h-11 md:w-11">
