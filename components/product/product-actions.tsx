...
export function ProductActions({
  ...
  const cartButtonClasses =
    "flex w-full items-center justify-center gap-2 rounded-full bg-blue-600 tracking-wide text-white";
      ...
      <div className="hidden space-y-2 md:block md:space-y-3">
        ...
        {storePhoneClean && (
          <button
            ...
            className="relative flex w-full items-center justify-center rounded-full border-2 border-blue-600 p-4 tracking-wide text-blue-600 transition-colors hover:bg-blue-50"
            type="button"
          >
        ...
        {phone && (
          <a
            ...
            className="relative flex w-full items-center justify-center rounded-full border-2 border-green-600 p-4 tracking-wide text-green-600 transition-colors hover:bg-green-50"
          >
            Order via WhatsApp
          </a>
        )}
        ...
        <div className="fixed inset-x-0 bottom-0 z-50 flex translate-y-0 items-center gap-2 border-t border-neutral-200 bg-white/95 px-3 py-2 shadow-[0_-8px_24px_rgba(0,0,0,0.12)] backdrop-blur supports-[padding:max(0px)]:pb-[max(0.5rem,env(safe-area-inset-bottom))] md:hidden">
          ...
          {phone && (
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex w-full items-center justify-center gap-1.5 rounded-full bg-green-600 p-3 text-sm font-medium text-white shadow-sm"
            >
